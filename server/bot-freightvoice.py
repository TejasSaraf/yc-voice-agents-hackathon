...
async def run_bot(
    ...
    # Speech-to-Text — Nemotron Speech Streaming, served over WebSocket (16 kHz mono PCM).
    stt = NVidiaWebSocketSTTService(
        url=os.getenv("NVIDIA_ASR_URL", "ws://192.168.7.228:8081"),
        strip_interim_prefix=True,
    )

    # LLM — Nemotron-3-Super-120B via vLLM (OpenAI-compatible /v1). Keep thinking
    # OFF for low-latency voice unless the server has a reasoning parser.
